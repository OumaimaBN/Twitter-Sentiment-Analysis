...
consumer = KafkaConsumer('twitterstream',bootstrap_servers=['localhost:9092'])#,auto_offset_reset='smallest')
...
for msg in consumer:
    ...
    try:
       twitter_rec = {'text':text,'senti_val':senti_val,'creation_datetime':creation_datetime,'username' :username,'location':location,
